...
public class Meio extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtn1prova.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Informe nota da 1° Prova");
            return;
        }
        aluno.setNprova1(Double.parseDouble(txtn1prova.getText()));
        
        if (txtn2prova.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Informe nota da 2° Prova");
            return;
        }
        aluno.setNprova2(Double.parseDouble(txtn2prova.getText()));
        
        if (txtntrabalho.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Informe nota da 3° Prova");
            return;
        }
